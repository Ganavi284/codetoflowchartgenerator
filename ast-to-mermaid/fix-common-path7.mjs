// Fix import paths for common in loop files (correct path - 4 levels up to reach src/)
import fs from 'fs';
...
files.forEach(filePath => {
  if (fs.existsSync(filePath)) {
    ...
    // Fix the common import path - should be ../../../../common/common.mjs from loops directory (4 levels up)
