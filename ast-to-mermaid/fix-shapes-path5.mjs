// Fix import paths for shapes in loop files (correct path - 4 levels up, not 3)
import fs from 'fs';
...
files.forEach(filePath => {
  if (fs.existsSync(filePath)) {
    ...
    // Fix the shapes import path - should be ../../../../mermaid/shapes.mjs from loops directory (4 levels up, not 3)
