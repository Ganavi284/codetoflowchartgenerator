...
console.log('Pascal Else-If Grade Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-else-if-grade.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-else-if-grade-output.mmd';
