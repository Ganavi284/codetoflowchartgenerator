...
console.log('Pascal Simple Else Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-simple-else.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-simple-else-output.mmd';
