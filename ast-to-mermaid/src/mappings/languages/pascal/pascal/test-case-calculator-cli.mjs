...
console.log('Pascal Case Calculator Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-case-calculator.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-case-calculator-output.mmd';
