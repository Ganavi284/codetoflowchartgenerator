...
console.log('Pascal Complex Else-If Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-complex-else-if.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-complex-else-if-output.mmd';
