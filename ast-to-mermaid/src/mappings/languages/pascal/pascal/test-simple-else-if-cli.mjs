...
console.log('Pascal Simple Else-If Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-simple-else-if.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-simple-else-if-output.mmd';
