...
console.log('Pascal Else Separation Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-else-separation.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-else-separation-output.mmd';
