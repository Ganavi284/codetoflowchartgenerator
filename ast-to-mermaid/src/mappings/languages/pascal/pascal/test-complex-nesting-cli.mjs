...
console.log('Pascal Complex Nesting Test to Mermaid Converter\n');

// Read the Pascal test file
const sourceFile = process.argv[2] || 'test-complex-nesting.pas';
...
try {
  ...
  // Save to output file
  const outputFile = 'test-complex-nesting-output.mmd';
