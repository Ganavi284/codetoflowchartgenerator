// Fix import paths for shapes in loop files (remove extra mappings/ from path)
import fs from 'fs';
...
files.forEach(filePath => {
  if (fs.existsSync(filePath)) {
    ...
    // Fix the shapes import path - should be ../../../mermaid/shapes.mjs from loops directory (not ../../../mappings/mermaid/)
