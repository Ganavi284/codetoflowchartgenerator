// Fix import paths for shapes in loop files (add one more ../ to go up from languages/)
import fs from 'fs';
...
files.forEach(filePath => {
  if (fs.existsSync(filePath)) {
    ...
    // Fix the shapes import path - should be ../../../../mermaid/shapes.mjs from loops directory (not ../../../mermaid/)
