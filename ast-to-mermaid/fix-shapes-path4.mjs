// Fix import paths for shapes in loop files (correct path - 3 levels up, not 4)
import fs from 'fs';
...
files.forEach(filePath => {
  if (fs.existsSync(filePath)) {
    ...
    // Fix the shapes import path - should be ../../../mermaid/shapes.mjs from loops directory (3 levels up, not 4)
